...
- Monte Carlo support through both legacy route-facing utilities and a newer Monte Carlo engine integration
...
- a newer engine-style Monte Carlo implementation used through dynamic loading in some workflows

This means Monte Carlo modernization is only partially complete and remains an area for future cleanup.
...
When making changes to this codebase, a low-risk approach is recommended:
- make one change at a time
- preserve existing behavior unless intentionally changing it
- update routes, models, and templates in controlled sequence
- verify user-facing labels and backend references together when renaming modules
- treat legacy and active pricing modules carefully before retiring older files
