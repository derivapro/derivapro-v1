        ...
        if last_analysis_result_id:
            ...
            if latest_analysis:
                if latest_analysis.analysis_type == "sensitivity":
                    sensitivity_results = latest_analysis.result_json or None
                elif latest_analysis.analysis_type == "scenario":
                    scenario_results = latest_analysis.result_json or None
                elif latest_analysis.analysis_type == "convergence":
                    convergence_results = latest_analysis.result_json or None
    else:
        sensitivity_results = session.get("sensitivity_results")
        scenario_results = session.get("scenario_results")
        convergence_results = session.get("convergence_results")
    ...
    if request.method == "POST":
        ...
        if action == "sensitivity":
            ...
            if current_user.is_authenticated and latest_analysis:
                ...
                sensitivity_data = session.get("sensitivity_results") or {}
            ...
            try:
                ...
                gpt_scenario_assessment = scenario_results.get(
            ...
            if current_user.is_authenticated and latest_analysis:
                ...
                scenario_data = session.get("scenario_results") or {}
            ...
            try:
                ...
                if current_user.is_authenticated:
                    ...
                    session["convergence_results"] = convergence_results_data
            ...
            if current_user.is_authenticated and latest_analysis:
                ...
                convergence_data = session.get("convergence_results") or {}
    ...
    if current_user.is_authenticated:
        ...
        if last_analysis_result_id:
            ...
            if latest_analysis and latest_analysis.result_json:
                ...
                elif latest_analysis.analysis_type == "risk_pl":
                ...
                if model_name == "Monte Carlo" and mode == "simulations":
                    try:
                        ...
                        if current_user.is_authenticated:
                            ...
                            session["convergence_results"] = convergence_results
